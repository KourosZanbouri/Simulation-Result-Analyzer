#### This files plots SINR vs Distance, with "IDIRECT" SINR (export from rcvdSInr plot ) with distance "INDIRECT", with Errorbar
...
plt.errorbar(grouped_data['distance_bin'].astype(str), grouped_data['mean_sinr'], 
             yerr=[grouped_data['mean_sinr'] - grouped_data['min_sinr'], 
                   grouped_data['max_sinr'] - grouped_data['mean_sinr']], 
             fmt='-o', label='UE [0]', capsize=5)
