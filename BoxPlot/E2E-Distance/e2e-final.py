...
for folder_index in range(7, 10):
...
meanprops = dict(marker='o', markerfacecolor='red', markeredgecolor='black', markersize=10)  # Customize mean symbol

# Create the boxplot using matplotlib directly
ax = df_combined.boxplot(column='Value', by='Profile-Distance-Stream', grid=False, showmeans=True, showfliers=True, patch_artist=True, figsize=(14,8), meanprops=meanprops)
...
plt.legend(handles, streams, loc='upper left', fontsize=18)
